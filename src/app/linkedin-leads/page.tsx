...
function LinkedInLeadsContent() {
  ...
  const navigate = (newPage: number) => {
    ...
    router.push(`/linkedin-leads?${params}`);
  };
  ...
  if (!account) {
    return (
      <div>
        <h1 className="text-2xl font-bold mb-1">LinkedIn Leads</h1>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-2xl font-bold">LinkedIn Leads</h1>
