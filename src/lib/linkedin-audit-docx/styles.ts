...
const WIDE_HEADERS = /commentary|assessment|why they matter|post concept|hook/i;
...
function computeColumnWidths(headers: string[]): number[] {
  ...
  // Give narrow columns a small fixed share, wide columns split the rest equally.
